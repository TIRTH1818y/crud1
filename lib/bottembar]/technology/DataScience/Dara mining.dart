      ...
      body:   Column(
        children: [
          Container(
            ...
            child: Image.asset(
              "assets/technology/data__mining.gif",
              fit: BoxFit.fill,
            ),
          ),
          Divider(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          "Cleaning, transforming, and integrating data to make it suitable for analysis.",
                          style: TextStyle(color: Colors.black, fontSize: 15),
                        ),
                        Text(
                          ":: Data Mining :: ",
                        ...
                        Text(
                          " Applying data mining algorithms to discover patterns and trends.",
                          style: TextStyle(color: Colors.black, fontSize: 15),
                        ),
                        Text(
                          ":: Pattern Evaluation :: ",
                        ...
                        Text(
                          " Assessing the significance and relevance of the discovered patterns.",
                          style: TextStyle(color: Colors.black, fontSize: 15),
                        ),
                        Text(
                          ":: Knowledge Discovery :: ",
                        ...
                        Text(
                          " Extracting actionable insights from the patterns.",
                          style: TextStyle(color: Colors.black, fontSize: 15),
                        ),
                      ],
                    ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: const ListTile(
                    ...
                    subtitle: Text(
                      "PDFs : Data Mining,Data Mining introductoty nd Advanced Topics.....",
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: const Text(
                      "Book :Introduction Data Mining,Data Mining Concepts and Techniques........",
                      style: TextStyle(color: Colors.black),
                    ),
